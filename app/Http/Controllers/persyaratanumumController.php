...
class persyaratanumumController extends Controller
{
    ...
    public function store(Request $request, $id_perusahaan)
    {
        ...
        $pu->id_perusahaan = $id_perusahaan;
        ...
        return redirect('/keuanganpajak/' . $id_perusahaan);
    }
    ...
    public function edit($id)
    {
        ...
        return view('Datavendor.edit_pu', compact('pu'));
        //
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/keuanganpajak/edit/' . $id);
    }
