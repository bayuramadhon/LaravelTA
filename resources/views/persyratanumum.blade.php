...
@endif
    ...
    <div class="form-row mt-3">
        <div class="col-ms-2 col-form-label">Surat Keterangan Domisili :</div>
            ...
            <div class="col-sm-3">
                <input type="file" class="form-control @error('FileSDOM') is-invalid @enderror" 
    ...
    <div class="container">
        <div class="form-group row mt-4">
            <div class="col-sm-2 col-form-label">Surat permohonan menjadi rekan</div>
                <div class="col-sm-3">
                <input type="file" class="form-control @error('FileSpmr') is-invalid @enderror" 
    ...
    <div class="form-row ">
        <div class="col-ms-2 col-form-label">Tanda Daftar Perusahaan :</div>
            ...
            <div class="col-sm-3">
                <input type="file" class="form-control @error('FileTDP') is-invalid @enderror" 
    ...
    <div class="form-group row mt-4">
        <div class="col-sm-2 col-form-label">Surat Pernyataan kebenaran dokumen</div>
            <div class="col-sm-3">
            <input type="file" class="form-control @error('FileSPKD') is-invalid @enderror" 
