    ...
    <div class="container">
        ...
        <div class="form-group row mt-3">
            ...
            <div class="col-sm-2">
                ...
                @enderror
                <div class="col-mb-10">
                    <input type="file" class="@error('FileNPWP') is-invalid @enderror" value="{{ old('FileNPWP') }}" name="FileNPWP">
                    @error('FileNPWP')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                ...
                @enderror
                <input type="file" class="@error('SPPKP') is-invalid @enderror"  value="{{ old('SFileSppkp') }}" name="FileSppkp">
                @error('FileSppkp')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control @error('Spt_No') is-invalid @enderror" value="{{ old('Spt_No') }}" id="SPT" name="Spt_No"
                    >
                @error('Spt_No')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                ...
                @enderror
                <input type="file" class="@error('FileSpt') is-invalid @enderror"  value="{{ old('FileSpt') }}" name="FileSpt">
                @error('FileSpt')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="form-group row">
                ...
                <div class="col-sm-2">
                    ...
                    @enderror
                    <input type="file" class="@error('FileSpp') is-invalid @enderror" value="{{ old('FileSpp') }}" name="FileSpp">
                    @error('FileSpp')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
        ...
        <div class="form-row" style="margin-left: 10px!important;">
                    ...
                    <div class="col-md-2">
                        <input type="text" class="form-control @error('bank') is-invalid @enderror" id="bank"
                            placeholder="Nama Bank" name="bank" value="{{ old('bank') }}">
                        @error('bank')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-2">
                        <input type="text" class="form-control @error('Rekenig') is-invalid @enderror" id="Rekenig"
                            placeholder="Rek" name="Rek" value="{{ old('Rek') }}">
                        @error('Rekenig')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-sm-3">
                        <input type="file" class="form-control @error(' FileBank') is-invalid @enderror" value="{{ old(' FileBank') }}" id=" FileBank"
                            name=" FileBank" >
                        @error(' FileBank')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control  @error('Ekuitas') is-invalid @enderror" id="Ekuitas"
                    name="Ekuitas" value="{{ old('Ekuitas') }}">
                @error('Ekuitas')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="file" class="form-control @error('FileKd') is-invalid @enderror" value="{{ old(' FileKd') }}" id="FileKd" name="FileKd">
                @error('FileKd')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
