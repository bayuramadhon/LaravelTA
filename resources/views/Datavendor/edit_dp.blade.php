...
<div class="container">
    ...
    <form method="post">
        ...
        <div class="form-group row mt-3">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control @error('divisi') is-invalid @enderror" id="divisi" name="divisi"
                    value="{{ $dp->divisi }}">
                @error('divisi')
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control @error('jenisVendor') is-invalid @enderror" id="jenisVendor"
                    name="jenisVendor" value="{{ $dp->jenisVendor }}">
                @error('jenisVendor')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control @error('almtperusahan') is-invalid @enderror" id="almtperusahan"
                    name="almtperusahan" value="{{ $dp->almtperusahan }}">
                @error('almtperusahan')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
